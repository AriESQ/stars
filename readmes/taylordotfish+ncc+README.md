...
Ensure [Rust][rust-inst] is installed. The latest version is highly
recommended; versions as old as 1.74 are technically supported, but they may
...
like “*X* cannot be built because it requires rustc *Y* or newer”. In that
case, run this command instead:
...
the latest version of Rust is recommended.
