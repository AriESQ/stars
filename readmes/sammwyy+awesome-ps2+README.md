...
- [hdl-dump](https://github.com/ps2homebrew/hdl-dump)  Install games in HDLoader format to APA-formatted hard drive 
...
- [RetroNas](https://github.com/retronas/retronas/wiki/OpenPS2Loader)  Network storage for different retro computers and consoles, to be used with OpenPS2Loader
