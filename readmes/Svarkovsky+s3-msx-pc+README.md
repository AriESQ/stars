...
[![CNX-Software](https://img.shields.io/badge/Featured%20on-CNX--Software-orange)](https://www.cnx-software.com/2026/06/11/bare-metal-msx2-emulator-for-esp32-s3-offers-custom-lcd_cam-vga-implementation-z80-optimizations/)
...
> <img src="img/me.jpg" align="left" width="130" alt="Ivan Svarkovsky">
>
...
![ESP32-S3-WROOM-1-N16R8](img/ESP32-S3-WROOM-1-N16R8.jpg)
...
2. Extract the file `full_dump_1.0.0-msx-pc_clean_and_clear.bin`.
   - *Verify integrity:* `md5sum` should be `080c4718445c6828d83699f0d75757c4`.
3. Flash it using `esptool.py` with a single command:

```bash
esptool.py -p /dev/ttyUSB0 -b 460800 write_flash 0x0 full_dump_1.0.0-msx-pc_clean_and_clear.bin
```
...
![collage](img/collage_2026-06-07_22-25-13.jpg)
...
<div align="center">
  <img src="img/photo_2026-06-09_14-45-56.jpg" width="50%" alt="Prototype Board">
  <br>
...
### Загальна схема
![Загальна схема](img/circuit.png)
...
2. Розпакуйте файл `full_dump_1.0.0-msx-pc_clean_and_clear.bin`.
   - *Перевірка цілісності:* `md5sum` має бути `080c4718445c6828d83699f0d75757c4`.
...
![collage](img/collage_2026-06-12_20-39-40.jpg)
...
2. Entpacken Sie die Datei `full_dump_1.0.0-msx-pc_clean_and_clear.bin`.
   - *Integritätsprüfung:* `md5sum` sollte `080c4718445c6828d83699f0d75757c4` sein.
...
<div align="center">
  <img src="img/collage_2026-06-12_20-42-30.jpg" width="550" alt="King's Valley">
</div>
...
2. ファイル `full_dump_1.0.0-msx-pc_clean_and_clear.bin` を展開。
   - *整合性確認：* `md5sum` は `080c4718445c6828d83699f0d75757c4` であること。
