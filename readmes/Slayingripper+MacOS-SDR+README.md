...
4. [CubicSDR](https://github.com/cjcliffe/CubicSDR) - A multi-platform SDR application that supports various SDR devices and offers features like spectrum display, waterfall visualization, and more.
...
10. [SDR++](https://github.com/AlexandreRouma/SDRPlusPlus/releases/tag/nightly) - SDR++ is a cross-platform and open source SDR software with the aim of being bloat free and simple to use.
